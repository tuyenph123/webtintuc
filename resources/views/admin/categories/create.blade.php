...
<div class="content-page">
    <div class="content">
        <form action="{{ route('categories.store') }}" method="POST" class="create__post">
            @csrf
            <div class="create__post-title">
                ...
                <div class="create__post-title__right">
                    <span><a href="../index.html">Trang chủ</a><i
                            class=" ri-arrow-drop-right-line"></i>
                        <a href>Thêm mới chuyên mục</a></span>
                </div>
            </div>
            <div class="Create__category-tong">
                <div class="Create__category-list">
                        <div class="create__post-item1">
                           <a style="background-color: green;" href="{{ route('categories.index') }}"><i class="ri-menu-line"></i> Danh sách</a>
                           <a style="background-color: rgb(0, 101, 253);" href=""><i class=" ri-refresh-line"></i> Refresh</a>
                        </div>
