                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h1 class="header-title">Danh sách bài viết</h1>
                        </div>
                        @if (session('success'))
                            ...
                            <div id="fixed-header-datatable_wrapper" class="dataTables_wrapper dt-bootstrap5">
                                <div class="row">
                                    ...
                                    <div class="list__posts">
                                        <form class="list_search" action="{{ route('news.index') }}" method="GET">
                                            <input class="list_search-item" type="search" placeholder="Mời nhập tiêu đề"
                                                name="" id="">
                                            <select class="select_chuyenmuc select2js" name="category_id" id="category_id"
                                                required>
                                        ...
                                        <div class="create__post-item1">
                                            <a style="background-color: green;" type="submit"
                                                href="{{ route('news.create') }}"><i class="ri-save-3-fill"></i> Thêm
                                                mới</a>
                                    ...
                                    <table id="fixed-header-datatable"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="sorting">Chuyên mục</th>
